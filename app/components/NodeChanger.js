...
export default class NodeChanger extends Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.browseForBitcoinNovad = this.browseForBitcoinNovad.bind(this);
  }
  ...
  findNode = () => {
    remote.shell.openExternal('http://lightnight.bitcoinnova.org/');
  };
  ...
  render() {
    ...
    return (
      <form onSubmit={this.changeNode}>
        ...
        <br />
        <p className={`has-text-weight-bold ${textColor}`}>
          BitcoinNovad.log file location:
        </p>
        <div className="field has-addons">
          ...
          <div className="control">
            <button
              ...
              onClick={this.browseForBitcoinNovad}
            >
              <span className="icon is-small">

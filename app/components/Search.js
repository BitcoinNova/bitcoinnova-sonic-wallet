...
export default class Search extends Component<Props, States> {
  ...
  openSearchInExplorer = () => {
    ...
    remote.shell.openExternal(
      `http://explorer.bitcoinnova.org/?hash=${encodeURIComponent(query)}`
    );
  };
  ...
  openInExplorer = (event: any) => {
    ...
    remote.shell.openExternal(
      `http://explorer.bitcoinnova.org/?hash=${encodeURIComponent(hash)}#blockchain_transaction`
    );
  };
                                ...
                                <tbody>
                                  <tr className="no-hover">
                                    ...
                                    <td>
                                      ...
                                      <br />
                                      {session.atomicToHuman(fee, true)} BTN
                                      <br />
                                      <p
                                        className={
                                          amount < 0
